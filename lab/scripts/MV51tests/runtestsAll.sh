...
set i="MV51Inputs"
#
echo " MV 5.1.20 Tests: Clearing Area ..."
...
echo " MV 5.1.20 Test 1: Solar HII region ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./map51 < "$s/01_solhii.mv" >map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/MV52test_$d.txt"
cat timing.txt
awk -f "$s/01_solhii.awk" photn0001.ph6 >> "$r/MV52test_$d.txt"
awk -f "$s/01_solhii.awk" photn0001.ph6
echo " MV 5.1.20 Test 2: Primordial HII region ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./map51 < "$s/02_primhii.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/MV52test_$d.txt"
cat timing.txt
awk -f "$s/02_primordial.awk" photn0002.ph6 >> "$r/MV52test_$d.txt"
awk -f "$s/02_primordial.awk" photn0002.ph6
echo " MV 5.1.20 Test 3: Test Solar Z 100kK PN ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./map51 < "$s/03_testpn2.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/MV52test_$d.txt"
cat timing.txt
awk -f "$s/03_testpn2.awk" photn0003.ph6 >> "$r/MV52test_$d.txt"
awk -f "$s/03_testpn2.awk" photn0003.ph6
echo " MV 5.1.20 Test 4: Dusty Isobaric Low Z HII region ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./map51 < "$s/04_dustyhii.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/MV52test_$d.txt"
cat timing.txt
awk -f "$s/04_dustyhii.awk" photn0004.ph6 >> "$r/MV52test_$d.txt"
awk -f "$s/04_dustyhii.awk" photn0004.ph6
echo " MV 5.1.20 Test 5: Dusty Isobaric PAH HII region ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./map51 < "$s/05_dustypah.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/MV52test_$d.txt"
cat timing.txt
awk -f "$s/05_dustypah.awk" photn0005.ph6 >> "$r/MV52test_$d.txt"
awk -f "$s/05_dustypah.awk" photn0005.ph6
echo " MV 5.1.20 Test 6: 200 km/s iterative shock ..."
date | awk '{print " "$0}' > timing.txt
echo " $HOST" > timing.txt
...
echo " MV 5.1.20 Tests completed. Output in "$r/MV52test_$d.txt""
rm -f timing.txt map5output.txt
