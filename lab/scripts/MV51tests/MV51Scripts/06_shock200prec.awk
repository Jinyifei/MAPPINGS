...
END{
print " MV 5.1 S5 Test 06b 200km/s shock Precursor Solar Metallicity"
print  " Quantity      ,   MVS5,   Model,  Diff%"
hb = hbeta*1e5
printf(" HBeta e5 4861 ,  0.627, %7.3f, %6.1f\n", hb,         100*(hb          - 0.62723)/ 0.62723);
printf(" Lya      1215 , 47.482, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 47.4823)/ 47.4823);
printf(" HeI      5876 ,  0.083, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 0.08265)/ 0.08265);
printf(" HeII     4686 ,  0.174, %7.3f, %6.1f\n", heii4686,   100*( heii4686   - 0.17375)/ 0.17375);
printf(" CIV      1549 ,  0.016, %7.3f, %6.1f\n", civ1549,    100*( civ1549    - 0.01617)/ 0.01617);
printf(" CIII     1909 ,  1.015, %7.3f, %6.1f\n", ciii1909,   100*( ciii1909   - 1.01521)/ 1.01521);
printf(" CII      2326 ,  0.288, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 0.28802)/ 0.28802);
printf(" NI       5200 ,  0.049, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 0.04871)/ 0.04871);
printf(" NII      5755 ,  0.015, %7.3f, %6.1f\n", nii5755,    100*( nii5755    - 0.01447)/ 0.01447);
printf(" NII      6548 ,  0.246, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 0.24627)/ 0.24627);
printf(" NII      6584 ,  0.725, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 0.72457)/ 0.72457);
printf(" NIII     1749 ,  0.022, %7.3f, %6.1f\n", niii1749,   100*( niii1749   - 0.02145)/ 0.02145);
printf(" NIV      1485 ,  0.001, %7.3f, %6.1f\n", niv1485,    100*( niv1485    - 0.00139)/ 0.00139);
printf(" OI       6300 ,  0.207, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 0.20651)/ 0.20651);
printf(" OII      3727 ,  4.592, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 4.59723)/ 4.59723);
printf(" OII      7319 ,  0.052, %7.3f, %6.1f\n", oii7319,    100*( oii7319    - 0.05242)/ 0.05242);
printf(" OII      7330 ,  0.043, %7.3f, %6.1f\n", oii7330,    100*( oii7330    - 0.04247)/ 0.04247);
printf(" OIII     1663 ,  0.033, %7.3f, %6.1f\n", oiii1663,   100*( oiii1663   - 0.03303)/ 0.03303);
printf(" OIII     4363 ,  0.034, %7.3f, %6.1f\n", oiii4363,   100*( oiii4363   - 0.03355)/ 0.03355);
printf(" OIII     4959 ,  2.027, %7.3f, %6.1f\n", oiii4959,   100*( oiii4959   - 2.02710)/ 2.02710);
printf(" OIII     5007 ,  5.859, %7.3f, %6.1f\n", oiii5007,   100*( oiii5007   - 5.85929)/ 5.85929);
printf(" OIV    25.89m ,  1.387, %7.3f, %6.1f\n", oiv2589m,   100*( oiv2589m   - 1.38715)/ 1.38715);
printf(" NeII   12.81m ,  0.078, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 0.07832)/ 0.07832);
printf(" NeIII  15.55m ,  0.947, %7.3f, %6.1f\n", neiii1555m, 100*( neiii1555m - 0.94707)/ 0.94707);
printf(" NeIV     2423 ,  0.020, %7.3f, %6.1f\n", neiv2423,   100*( neiv2423   - 0.02009)/ 0.02009);
printf(" MgII     2798 ,  1.286, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 1.28583)/ 1.28583);
printf(" SiIII    1892 ,  0.236, %7.3f, %6.1f\n", sliii1892,  100*( sliii1892  - 0.23618)/ 0.23618);
printf(" SiIII    2335 ,  0.215, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 0.21484)/ 0.21484);
printf(" SiIII  18.71m ,  0.743, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 0.74272)/ 0.74272);
printf(" SiIV     1397 ,  0.003, %7.3f, %6.1f\n", siiv1397,   100*( siiv1397   - 0.00281)/ 0.00281);
printf(" SII      6716 ,  0.310, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 0.30980)/ 0.30980);
printf(" SII      6731 ,  0.215, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 0.21454)/ 0.21454);
printf(" SIII     6312 ,  0.040, %7.3f, %6.1f\n", siii6312,   100*( siii6312   - 0.03967)/ 0.03967);
printf(" SIII     9069 ,  0.575, %7.3f, %6.1f\n", siii9069,   100*( siii9069   - 0.57461)/ 0.57461);
printf(" SIII     9531 ,  1.443, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.44340)/ 1.44340);
printf(" SIV    10.51m ,  0.404, %7.3f, %6.1f\n", siv1051m,   100*( siv1051m   - 0.40398)/ 0.40398);
printf(" ArII   6.985m ,  0.002, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 0.00185)/ 0.00185);
printf(" FeII   1.643m ,  0.110, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 0.11044)/ 0.11044);
printf(" FeII   17.93m ,  0.024, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 0.02440)/ 0.02440);
printf(" NiII   6.636m ,  0.010, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 0.01007)/ 0.01007);
...
suml = suml*hb;
printf(" Ltot          , 44.976, %7.3f, %6.1f\n", suml   , 100*(suml     - 44.9755)/44.9755);
}
