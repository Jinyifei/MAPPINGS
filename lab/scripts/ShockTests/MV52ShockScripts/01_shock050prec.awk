...
hb = hbeta*1e10
printf(" HBeta e10 4861,  0.930, %7.3f, %6.1f\n", hb,         100*(hb          - 9.30102e-01)/ 9.30102e-01);
printf(" Lya      1215 , 45.300, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 4.53004e+01)/ 4.53004e+01);
printf(" HeI      5876 ,  0.060, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 6.03908e-02)/ 6.03908e-02);
printf(" CII      2326 ,  3.209, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 3.20859e+00)/ 3.20859e+00);
printf(" NI       5200 ,  5.900, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 5.89968e+00)/ 5.89968e+00);
printf(" NII      5755 , 0.0018, %7.4f, %6.1f\n", nii5755,    100*( nii5755    - 1.82101e-03)/ 1.82101e-03);
printf(" NII      6548 ,  0.069, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 6.87465e-02)/ 6.87465e-02);
printf(" NII      6584 ,  0.202, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 2.02265e-01)/ 2.02265e-01);
printf(" OI       6300 , 10.166, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 1.01660e+01)/ 1.01660e+01);
printf(" OII      3727 ,  0.471, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 4.70529e-01)/ 4.70529e-01);
printf(" OII      7319 , 0.0033, %7.4f, %6.1f\n", oii7319,    100*( oii7319    - 3.29054e-03)/ 3.29054e-03);
printf(" OII      7330 , 0.0027, %7.4f, %6.1f\n", oii7330,    100*( oii7330    - 2.66607e-03)/ 2.66607e-03);
printf(" NeII   12.81m ,  0.082, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 8.18152e-02)/ 8.18152e-02);
printf(" MgII     2798 , 26.604, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 2.66037e+01)/ 2.66037e+01);
printf(" SiIII    2335 ,  0.877, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 8.76618e-01)/ 8.76618e-01);
printf(" SiIII  18.71m , 0.0016, %7.4f, %6.1f\n", siii1871m,  100*( siii1871m  - 1.63136e-03)/ 1.63136e-03);
printf(" SII      6716 , 14.899, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 1.48991e+01)/ 1.48991e+01);
printf(" SII      6731 , 10.229, %7.2f, %6.1f\n", sii6731,    100*( sii6731    - 1.02291e+01)/ 1.02291e+01);
printf(" ArII   6.985m ,  0.015, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 1.47955e-02)/ 1.47955e-02);
printf(" FeII   1.643m , 12.051, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 1.20511e+01)/ 1.20511e+01);
printf(" FeII   17.93m ,  3.806, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 3.80620e+00)/ 3.80620e+00);
printf(" NiII   6.636m ,  1.072, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 1.07203e+00)/ 1.07203e+00);
...
suml = suml*hb;
printf(" Ltot          , 125.59, %7.2f, %6.1f\n", suml   , 100*(suml     - 1.25586e+02)/1.25586e+02);
}
