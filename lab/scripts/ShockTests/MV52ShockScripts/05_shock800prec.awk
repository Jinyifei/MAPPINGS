...
END{
print  " MV 5.2 Shock Test 05: 800km/s Precursor"
print  " Quantity      ,   MVS5,   Model,  Diff%"
hb = hbeta*1e4
printf(" HB  e-04 4861 , 2.6543, %7.4f, %6.1f\n", hb,         100*(hb          - 2.65429e+00)/ 2.65429e+00);
printf(" Lya      1215 , 80.052, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 8.00518e+01)/ 8.00518e+01);
printf(" HeI      5876 ,  0.040, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 3.97549e-02)/ 3.97549e-02);
printf(" HeII     4686 ,  0.372, %7.3f, %6.1f\n", heii4686,   100*( heii4686   - 3.72178e-01)/ 3.72178e-01);
printf(" CII      2326 ,  0.923, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 9.23099e-01)/ 9.23099e-01);
printf(" CIII     1909 ,  6.184, %7.3f, %6.1f\n", ciii1909,   100*( ciii1909   - 6.18375e+00)/ 6.18375e+00);
printf(" CIV      1549 , 23.383, %7.3f, %6.1f\n", civ1549,    100*( civ1549    - 2.33834e+01)/ 2.33834e+01);
printf(" NI       5200 ,  0.545, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 5.44987e-01)/ 5.44987e-01);
printf(" NII      5755 ,  0.028, %7.3f, %6.1f\n", nii5755,    100*( nii5755    - 2.84755e-02)/ 2.84755e-02);
printf(" NII      6548 ,  0.539, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 5.39048e-01)/ 5.39048e-01);
printf(" NII      6584 ,  1.586, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 1.58598e+00)/ 1.58598e+00);
printf(" NIII     1749 ,  0.241, %7.3f, %6.1f\n", niii1749,   100*( niii1749   - 2.40746e-01)/ 2.40746e-01);
printf(" NIV      1485 ,  1.410, %7.3f, %6.1f\n", niv1485,    100*( niv1485    - 1.40970e+00)/ 1.40970e+00);
printf(" OI       6300 ,  1.952, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 1.95212e+00)/ 1.95212e+00);
printf(" OII      3727 ,  1.940, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 1.93967e+00)/ 1.93967e+00);
printf(" OII      7319 ,  0.025, %7.3f, %6.1f\n", oii7319,    100*( oii7319    - 2.51705e-02)/ 2.51705e-02);
printf(" OII      7330 ,  0.020, %7.3f, %6.1f\n", oii7330,    100*( oii7330    - 2.03974e-02)/ 2.03974e-02);
printf(" OIII     1663 ,  1.194, %7.3f, %6.1f\n", oiii1663,   100*( oiii1663   - 1.19359e+00)/ 1.19359e+00);
printf(" OIII     4363 ,  0.362, %7.3f, %6.1f\n", oiii4363,   100*( oiii4363   - 3.62472e-01)/ 3.62472e-01);
printf(" OIII     4959 ,  3.932, %7.3f, %6.1f\n", oiii4959,   100*( oiii4959   - 3.93222e+00)/ 3.93222e+00);
printf(" OIII     5007 , 11.366, %7.3f, %6.1f\n", oiii5007,   100*( oiii5007   - 1.13660e+01)/ 1.13660e+01);
printf(" OIV    25.89m ,  4.817, %7.3f, %6.1f\n", oiv2589m,   100*( oiv2589m   - 4.81709e+00)/ 4.81709e+00);
printf(" NeII   12.81m ,  0.258, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 2.58087e-01)/ 2.58087e-01);
printf(" NeIII  15.55m ,  1.061, %7.3f, %6.1f\n", neiii1555m, 100*( neiii1555m - 1.06141e+00)/ 1.06141e+00);
printf(" NeIV     2423 ,  1.269, %7.3f, %6.1f\n", neiv2423,   100*( neiv2423   - 1.26930e+00)/ 1.26930e+00);
printf(" MgII     2798 ,  2.238, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 2.23839e+00)/ 2.23839e+00);
printf(" SiIII    1892 ,  0.358, %7.3f, %6.1f\n", sliii1892,  100*( sliii1892  - 3.57945e-01)/ 3.57945e-01);
printf(" SiIII    2335 ,  0.419, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 4.18853e-01)/ 4.18853e-01);
printf(" SiIII  18.71m ,  0.719, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 7.18990e-01)/ 7.18990e-01);
printf(" SiIV     1397 ,  0.529, %7.3f, %6.1f\n", siiv1397,   100*( siiv1397   - 5.29006e-01)/ 5.29006e-01);
printf(" SII      6716 ,  0.383, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 3.82858e-01)/ 3.82858e-01);
printf(" SII      6731 ,  0.264, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 2.63735e-01)/ 2.63735e-01);
printf(" SIII     6312 ,  0.047, %7.3f, %6.1f\n", siii6312,   100*( siii6312   - 4.67269e-02)/ 4.67269e-02);
printf(" SIII     9069 ,  0.556, %7.3f, %6.1f\n", siii9069,   100*( siii9069   - 5.55942e-01)/ 5.55942e-01);
printf(" SIII     9531 ,  1.397, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.39650e+00)/ 1.39650e+00);
printf(" SIV    10.51m ,  0.308, %7.3f, %6.1f\n", siv1051m,   100*( siv1051m   - 3.07579e-01)/ 3.07579e-01);
printf(" ArII   6.985m ,  0.054, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 5.42612e-02)/ 5.42612e-02);
printf(" FeII   1.643m ,  1.340, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 1.33982e+00)/ 1.33982e+00);
printf(" FeII   17.93m ,  0.342, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 3.41831e-01)/ 3.41831e-01);
printf(" NiII   6.636m ,  0.089, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 8.94938e-02)/ 8.94938e-02);
...
suml = suml*hb;
printf(" Ltot  e-04    , 427.38, %7.2f, %6.1f\n", suml   , 100*(suml     - 4.27383e+02)/4.27383e+02);
}
