...
hb = hbeta*1e4
printf(" HBeta e4 4861 ,  2.687, %7.3f, %6.1f\n", hb,         100*(hb          - 2.68707e+00)/ 2.68707e+00);
printf(" Lya      1215 , 78.895, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 7.88950e+01)/ 7.88950e+01);
printf(" HeI      5876 ,  0.039, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 3.89864e-02)/ 3.89864e-02);
printf(" HeII     4686 ,  0.380, %7.3f, %6.1f\n", heii4686,   100*( heii4686   - 3.80097e-01)/ 3.80097e-01);
printf(" CII      2326 ,  0.911, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 9.10521e-01)/ 9.10521e-01);
printf(" CIII     1909 ,  6.043, %7.3f, %6.1f\n", ciii1909,   100*( ciii1909   - 6.04337e+00)/ 6.04337e+00);
printf(" CIV      1549 , 23.635, %7.3f, %6.1f\n", civ1549,    100*( civ1549    - 2.36349e+01)/ 2.36349e+01);
printf(" NI       5200 ,  0.540, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 5.40338e-01)/ 5.40338e-01);
printf(" NII      5755 ,  0.028, %7.3f, %6.1f\n", nii5755,    100*( nii5755    - 2.78539e-02)/ 2.78539e-02);
printf(" NII      6548 ,  0.529, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 5.29090e-01)/ 5.29090e-01);
printf(" NII      6584 ,  1.557, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 1.55668e+00)/ 1.55668e+00);
printf(" NIII     1749 ,  0.234, %7.3f, %6.1f\n", niii1749,   100*( niii1749   - 2.34472e-01)/ 2.34472e-01);
printf(" NIV      1485 ,  1.433, %7.3f, %6.1f\n", niv1485,    100*( niv1485    - 1.43314e+00)/ 1.43314e+00);
printf(" OI       6300 ,  1.927, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 1.92729e+00)/ 1.92729e+00);
printf(" OII      3727 ,  1.867, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 1.86716e+00)/ 1.86716e+00);
printf(" OII      7319 ,  0.024, %7.3f, %6.1f\n", oii7319,    100*( oii7319    - 2.40102e-02)/ 2.40102e-02);
printf(" OII      7330 ,  0.019, %7.3f, %6.1f\n", oii7330,    100*( oii7330    - 1.94570e-02)/ 1.94570e-02);
printf(" OIII     1663 ,  1.190, %7.3f, %6.1f\n", oiii1663,   100*( oiii1663   - 1.19027e+00)/ 1.19027e+00);
printf(" OIII     4363 ,  0.360, %7.3f, %6.1f\n", oiii4363,   100*( oiii4363   - 3.59597e-01)/ 3.59597e-01);
printf(" OIII     4959 ,  3.871, %7.3f, %6.1f\n", oiii4959,   100*( oiii4959   - 3.87078e+00)/ 3.87078e+00);
printf(" OIII     5007 , 11.188, %7.3f, %6.1f\n", oiii5007,   100*( oiii5007   - 1.11884e+01)/ 1.11884e+01);
printf(" OIV    25.89m ,  4.820, %7.3f, %6.1f\n", oiv2589m,   100*( oiv2589m   - 4.82029e+00)/ 4.82029e+00);
printf(" NeII   12.81m ,  0.255, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 2.55193e-01)/ 2.55193e-01);
printf(" NeIII  15.55m ,  1.043, %7.3f, %6.1f\n", neiii1555m, 100*( neiii1555m - 1.04315e+00)/ 1.04315e+00);
printf(" NeIV     2423 ,  1.274, %7.3f, %6.1f\n", neiv2423,   100*( neiv2423   - 1.27350e+00)/ 1.27350e+00);
printf(" MgII     2798 ,  2.203, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 2.20315e+00)/ 2.20315e+00);
printf(" SiIII    1892 ,  0.342, %7.3f, %6.1f\n", sliii1892,  100*( sliii1892  - 3.42126e-01)/ 3.42126e-01);
printf(" SiIII    2335 ,  0.409, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 4.08685e-01)/ 4.08685e-01);
printf(" SiIII  18.71m ,  0.708, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 7.07716e-01)/ 7.07716e-01);
printf(" SiIV     1397 ,  0.521, %7.3f, %6.1f\n", siiv1397,   100*( siiv1397   - 5.20893e-01)/ 5.20893e-01);
printf(" SII      6716 ,  0.379, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 3.79202e-01)/ 3.79202e-01);
printf(" SII      6731 ,  0.261, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 2.61212e-01)/ 2.61212e-01);
printf(" SIII     6312 ,  0.046, %7.3f, %6.1f\n", siii6312,   100*( siii6312   - 4.57247e-02)/ 4.57247e-02);
printf(" SIII     9069 ,  0.547, %7.3f, %6.1f\n", siii9069,   100*( siii9069   - 5.46511e-01)/ 5.46511e-01);
printf(" SIII     9531 ,  1.373, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.37281e+00)/ 1.37281e+00);
printf(" SIV    10.51m ,  0.301, %7.3f, %6.1f\n", siv1051m,   100*( siv1051m   - 3.00853e-01)/ 3.00853e-01);
printf(" ArII   6.985m ,  0.054, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 5.36481e-02)/ 5.36481e-02);
printf(" FeII   1.643m ,  1.323, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 1.32303e+00)/ 1.32303e+00);
printf(" FeII   17.93m ,  0.338, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 3.37662e-01)/ 3.37662e-01);
printf(" NiII   6.636m ,  0.088, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 8.83711e-02)/ 8.83711e-02);
...
suml = suml*hb;
printf(" Ltot          , 428.93, %7.2f, %6.1f\n", suml   , 100*(suml     - 4.28928e+02)/4.28928e+02);
}
