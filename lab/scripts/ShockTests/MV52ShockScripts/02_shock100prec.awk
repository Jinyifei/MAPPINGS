...
hb = hbeta*1e7
printf(" HBeta e7 4861 ,  0.654, %7.3f, %6.1f\n", hb,         100*(hb          - 6.53830e-01)/ 6.53830e-01);
printf(" Lya      1215 , 275.55, %7.2f, %6.1f\n", lyalpha,    100*(lyalpha     - 2.75552e+02)/ 2.75552e+02);
printf(" HeI      5876 ,  0.009, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 8.78446e-03)/ 8.78446e-03);
printf(" CII      2326 ,  2.949, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 2.94945e+00)/ 2.94945e+00);
printf(" CIII     1909 ,  0.917, %7.3f, %6.1f\n", ciii1909,   100*( ciii1909   - 9.17072e-01)/ 9.17072e-01);
printf(" NI       5200 ,  1.207, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 1.20688e+00)/ 1.20688e+00);
printf(" NII      5755 ,  0.042, %7.3f, %6.1f\n", nii5755,    100*( nii5755    - 4.19661e-02)/ 4.19661e-02);
printf(" NII      6548 ,  0.501, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 5.00850e-01)/ 5.00850e-01);
printf(" NII      6584 ,  1.474, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 1.47359e+00)/ 1.47359e+00);
printf(" OI       6300 ,  3.116, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 3.11636e+00)/ 3.11636e+00);
printf(" OII      3727 ,  2.085, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 2.08520e+00)/ 2.08520e+00);
printf(" OII      7319 ,  0.034, %7.3f, %6.1f\n", oii7319,    100*( oii7319    - 3.36233e-02)/ 3.36233e-02);
printf(" OII      7330 ,  0.027, %7.3f, %6.1f\n", oii7330,    100*( oii7330    - 2.72486e-02)/ 2.72486e-02);
printf(" NeII   12.81m ,  0.146, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 1.45691e-01)/ 1.45691e-01);
printf(" NeIII  15.55m ,  0.011, %7.3f, %6.1f\n", neiii1555m, 100*( neiii1555m - 1.08760e-02)/ 1.08760e-02);
printf(" MgII     2798 , 19.896, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 1.98963e+01)/ 1.98963e+01);
printf(" SiIII    1892 ,  0.010, %7.3f, %6.1f\n", sliii1892,  100*( sliii1892  - 1.01777e-02)/ 1.01777e-02);
printf(" SiIII    2335 ,  0.977, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 9.77482e-01)/ 9.77482e-01);
printf(" SiIII  18.71m ,  0.062, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 6.16514e-02)/ 6.16514e-02);
printf(" SII      6716 ,  2.676, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 2.67557e+00)/ 2.67557e+00);
printf(" SII      6731 ,  1.861, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 1.86122e+00)/ 1.86122e+00);
printf(" SIII     6312 ,  0.010, %7.3f, %6.1f\n", siii6312,   100*( siii6312   - 9.62797e-03)/ 9.62797e-03);
printf(" SIII     9069 ,  0.071, %7.3f, %6.1f\n", siii9069,   100*( siii9069   - 7.13694e-02)/ 7.13694e-02);
printf(" SIII     9531 ,  0.179, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.79276e-01)/ 1.79276e-01);
printf(" ArII   6.985m ,  0.018, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 1.78552e-02)/ 1.78552e-02);
printf(" FeII   1.643m ,  1.169, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 1.16860e+00)/ 1.16860e+00);
printf(" FeII   17.93m ,  0.254, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 2.53709e-01)/ 2.53709e-01);
printf(" NiII   6.636m ,  0.061, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 6.12074e-02)/ 6.12074e-02);
...
suml = suml*hb;
printf(" Ltot          , 206.18, %7.2f, %6.1f\n", suml   , 100*(suml     - 2.06182e+02)/2.06182e+02);
}
