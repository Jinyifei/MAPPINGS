...
hb = hbeta*1e6
printf(" HBeta e6 4861 ,  1.060, %7.3f, %6.1f\n", hb,         100*(hb          - 1.06032e+00)/ 1.06032e+00);
printf(" Lya      1215 , 92.125, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 9.21251e+01)/ 9.21251e+01);
printf(" HeI      5876 , 0.0030, %7.4f, %6.1f\n", hei5876,    100*( hei5876    - 3.04662e-03)/ 3.04662e-03);
printf(" CII      2326 ,  0.235, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 2.35424e-01)/ 2.35424e-01);
printf(" CIII     1909 , 0.0042, %7.4f, %6.1f\n", ciii1909,   100*( ciii1909   - 4.21044e-03)/ 4.21044e-03);
printf(" NI       5200 ,  0.188, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 1.87620e-01)/ 1.87620e-01);
printf(" NII      5755 , 0.0018, %7.4f, %6.1f\n", nii5755,    100*( nii5755    - 1.78477e-03)/ 1.78477e-03);
printf(" NII      6548 ,  0.045, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 4.53695e-02)/ 4.53695e-02);
printf(" NII      6584 ,  0.133, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 1.33485e-01)/ 1.33485e-01);
printf(" OI       6300 ,  0.347, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 3.46797e-01)/ 3.46797e-01);
printf(" OII      3727 ,  0.338, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 3.38019e-01)/ 3.38019e-01);
printf(" OII      7319 , 0.0037, %7.4f, %6.1f\n", oii7319,    100*( oii7319    - 3.70623e-03)/ 3.70623e-03);
printf(" OII      7330 , 0.0030, %7.4f, %6.1f\n", oii7330,    100*( oii7330    - 3.00321e-03)/ 3.00321e-03);
printf(" NeII   12.81m ,  0.011, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 1.07631e-02)/ 1.07631e-02);
printf(" MgII     2798 ,  1.298, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 1.29768e+00)/ 1.29768e+00);
printf(" SiIII    1892 , 0.0016, %7.4f, %6.1f\n", sliii1892,  100*( sliii1892  - 1.59743e-03)/ 1.59743e-03);
printf(" SiIII    2335 ,  0.062, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 6.19846e-02)/ 6.19846e-02);
printf(" SiIII  18.71m ,  0.017, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 1.67649e-02)/ 1.67649e-02);
printf(" SII      6716 ,  0.498, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 4.97881e-01)/ 4.97881e-01);
printf(" SII      6731 ,  0.345, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 3.45007e-01)/ 3.45007e-01);
printf(" SIII     6312 , 0.0005, %7.4f, %6.1f\n", siii6312,   100*( siii6312   - 4.67348e-04)/ 4.67348e-04);
printf(" SIII     9069 , 0.0079, %7.4f, %6.1f\n", siii9069,   100*( siii9069   - 7.86508e-03)/ 7.86508e-03);
printf(" SIII     9531 ,  0.020, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.97567e-02)/ 1.97567e-02);
printf(" ArII   6.985m ,  0.016, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 1.60891e-02)/ 1.60891e-02);
printf(" FeII   1.643m ,  0.365, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 3.65352e-01)/ 3.65352e-01);
printf(" FeII   17.93m ,  0.134, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 1.34211e-01)/ 1.34211e-01);
printf(" NiII   6.636m ,  0.054, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 5.44969e-02)/ 5.44969e-02);
...
suml = suml*hb;
printf(" Ltot          , 102.06, %7.2f, %6.1f\n", suml   , 100*(suml     - 1.02064e+02)/1.02064e+02);
}
