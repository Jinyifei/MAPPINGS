...
(time ./$exe < "$s/kt00T2_h20.mv" >map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T3_h40.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/lextest_$d.txt"
cat timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T4_h40pp.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/lextest_$d.txt"
cat timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T5_PN150.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/lextest_$d.txt"
cat timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T6_PN75Hi.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >>"$r/lextest_$d.txt"
cat timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T7_PN75Lo.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/lextest_$d.txt"
cat timing.txt
...
date | awk '{print " "$0}' > timing.txt
echo " $HOST" >> timing.txt
(time ./$exe < "$s/kt00T8_NLR.mv" >>map5output.txt)| awk '{print " "$1" "$2" "$3" "$4}'>> timing.txt
cat timing.txt >> "$r/lextest_$d.txt"
cat timing.txt
