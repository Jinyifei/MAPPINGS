...
proj_dir = "/Users/silaslee/Desktop/run_MAPPINGS_NLR/"  # tosca
...
param_names = ["E_peak","Gamma","p_NT","UH_at_r_inner", "Press_P/k", "abund", "dust_scenario"]  # One for each grid dimension
