...
templates = {
    ...
    "DF_99" : OrderedDict([   # "DF": Dust Free - model with no dust
        ...
        ("Abund_file", "lgc/lgc200.abn"), # zeta = 2.0?  Is this right?
        ...
        ("In_spectrum_file", "oxaf_spec.txt"),  # Input spectrum file
        ("Skip_n_lines", "2"),     # Number of header lines to skip in input spectrum file
        ("x-units", "F"),          # F: Energy in keV
        ("y-units", "H"),          # H: Specific energy flux F_E in (keV/cm^2/s)/keV
