...
parent_dir = "/avatar/silaslee/run_MAPPINGS_NLR/"  # tosca
...
grid_config = {
    ...
    "param_dict" : OrderedDict([
        ("E_peak", [-2.0, -1.8, -1.6, -1.5, -1.4, -1.2, -1.0]),  # log10(E/keV)
        ("Gamma", [2.0]),  #[1.3, 1.6, 1.9, 2.2, 2.5]), # Photon index
        ...
        ("UH_at_r_inner", [-1.0, -0.6, -0.2]),  # log10 U(H) at inner radius
        ("Press_P/k",  [4.0, 5.4, 5.8, 6.2, 6.6, 7.0, 7.4, 8.0]),  # log10 pressure (P/k)
        ("abund", [7.150, 7.750, 8.150, 8.427, 8.632, 8.760, 8.850, 8.943, \
                   8.997, 9.096, 9.180, 9.252]),  # 12 + log(O/H)
        # ("NoDust_UH", []), #[-1.5] Cutoff U(H) value at which dust is destroyed.  Log10 here over whole range.
...
if LOCAL_TEST:
    ...
    test_grid_dir = "/Users/silaslee/Desktop/run_MAPPINGS_NLR/"
