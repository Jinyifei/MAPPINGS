...
hb = hbeta*1e4
printf(" HB  e-04 4861 , 0.4375, %7.4f, %6.1f\n", hb,         100*(hb          - 4.37477e-01)/ 4.37477e-01);
printf(" Lya      1215 , 48.435, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 4.84350e+01)/ 4.84350e+01);
printf(" HeI      5876 ,  0.024, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 2.42246e-02)/ 2.42246e-02);
printf(" HeII     4686 ,  0.687, %7.3f, %6.1f\n", heii4686,   100*( heii4686   - 6.86918e-01)/ 6.86918e-01);
printf(" CII      2326 ,  0.300, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 2.99940e-01)/ 2.99940e-01);
printf(" CIII     1909 ,  5.271, %7.3f, %6.1f\n", ciii1909,   100*( ciii1909   - 5.27070e+00)/ 5.27070e+00);
printf(" CIV      1549 ,  4.772, %7.3f, %6.1f\n", civ1549,    100*( civ1549    - 4.77230e+00)/ 4.77230e+00);
printf(" NI       5200 ,  0.157, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 1.56860e-01)/ 1.56860e-01);
printf(" NII      5755 ,  0.009, %7.3f, %6.1f\n", nii5755,    100*( nii5755    - 9.49259e-03)/ 9.49259e-03);
printf(" NII      6548 ,  0.126, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 1.26186e-01)/ 1.26186e-01);
printf(" NII      6584 ,  0.371, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 3.71262e-01)/ 3.71262e-01);
printf(" NIII     1749 ,  0.217, %7.3f, %6.1f\n", niii1749,   100*( niii1749   - 2.17340e-01)/ 2.17340e-01);
printf(" NIV      1485 ,  0.360, %7.3f, %6.1f\n", niv1485,    100*( niv1485    - 3.60238e-01)/ 3.60238e-01);
printf(" OI       6300 ,  0.436, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 4.35877e-01)/ 4.35877e-01);
printf(" OII      3727 ,  1.666, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 1.66579e+00)/ 1.66579e+00);
printf(" OII      7319 ,  0.029, %7.3f, %6.1f\n", oii7319,    100*( oii7319    - 2.87615e-02)/ 2.87615e-02);
printf(" OII      7330 ,  0.023, %7.3f, %6.1f\n", oii7330,    100*( oii7330    - 2.33091e-02)/ 2.33091e-02);
printf(" OIII     1663 ,  0.507, %7.3f, %6.1f\n", oiii1663,   100*( oiii1663   - 5.07411e-01)/ 5.07411e-01);
printf(" OIII     4363 ,  0.229, %7.3f, %6.1f\n", oiii4363,   100*( oiii4363   - 2.28856e-01)/ 2.28856e-01);
printf(" OIII     4959 ,  4.229, %7.3f, %6.1f\n", oiii4959,   100*( oiii4959   - 4.22938e+00)/ 4.22938e+00);
printf(" OIII     5007 , 12.225, %7.3f, %6.1f\n", oiii5007,   100*( oiii5007   - 1.22249e+01)/ 1.22249e+01);
printf(" OIV    25.89m , 17.045, %7.3f, %6.1f\n", oiv2589m,   100*( oiv2589m   - 1.70452e+01)/ 1.70452e+01);
printf(" NeII   12.81m ,  0.082, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 8.21742e-02)/ 8.21742e-02);
printf(" NeIII  15.55m ,  0.652, %7.3f, %6.1f\n", neiii1555m, 100*( neiii1555m - 6.52021e-01)/ 6.52021e-01);
printf(" NeIV     2423 ,  1.306, %7.3f, %6.1f\n", neiv2423,   100*( neiv2423   - 1.30575e+00)/ 1.30575e+00);
printf(" MgII     2798 ,  0.720, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 7.20303e-01)/ 7.20303e-01);
printf(" SiIII    1892 ,  1.057, %7.3f, %6.1f\n", sliii1892,  100*( sliii1892  - 1.05746e+00)/ 1.05746e+00);
printf(" SiIII    2335 ,  0.251, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 2.51449e-01)/ 2.51449e-01);
printf(" SiIII  18.71m ,  0.531, %7.3f, %6.1f\n", siii1871m,  100*( siii1871m  - 5.31437e-01)/ 5.31437e-01);
printf(" SiIV     1397 ,  0.717, %7.3f, %6.1f\n", siiv1397,   100*( siiv1397   - 7.17051e-01)/ 7.17051e-01);
printf(" SII      6716 ,  0.082, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 8.20223e-02)/ 8.20223e-02);
printf(" SII      6731 ,  0.057, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 5.68282e-02)/ 5.68282e-02);
printf(" SIII     6312 ,  0.065, %7.3f, %6.1f\n", siii6312,   100*( siii6312   - 6.48397e-02)/ 6.48397e-02);
printf(" SIII     9069 ,  0.506, %7.3f, %6.1f\n", siii9069,   100*( siii9069   - 5.05627e-01)/ 5.05627e-01);
printf(" SIII     9531 ,  1.270, %7.3f, %6.1f\n", siii9531,   100*( siii9531   - 1.27011e+00)/ 1.27011e+00);
printf(" SIV    10.51m ,  2.878, %7.3f, %6.1f\n", siv1051m,   100*( siv1051m   - 2.87832e+00)/ 2.87832e+00);
printf(" ArII   6.985m ,  0.017, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 1.70866e-02)/ 1.70866e-02);
printf(" FeII   1.643m ,  0.327, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 3.26978e-01)/ 3.26978e-01);
printf(" FeII   17.93m ,  0.093, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 9.25606e-02)/ 9.25606e-02);
printf(" NiII   6.636m ,  0.027, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 2.68256e-02)/ 2.68256e-02);
...
suml = suml*hb;
printf(" Ltot   e-04   , 47.978, %7.3f, %6.1f\n", suml   , 100*(suml     - 4.79784e+01)/4.79784e+01);
}
