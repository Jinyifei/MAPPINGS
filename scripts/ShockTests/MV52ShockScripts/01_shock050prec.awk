...
END{
print  " MV 5.2 Shock Test 01: 50km/s Precursor"
print  " Quantity      ,   MVS5,   Model,  Diff%"
hb = hbeta*1e10
printf(" HB  e-10 4861 , 0.9751, %7.4f, %6.1f\n", hb,         100*(hb          - 9.75069e-01)/ 9.75069e-01);
printf(" Lya      1215 , 44.376, %7.3f, %6.1f\n", lyalpha,    100*(lyalpha     - 4.43763e+01)/ 4.43763e+01);
printf(" HeI      5876 ,  0.058, %7.3f, %6.1f\n", hei5876,    100*( hei5876    - 5.76776e-02)/ 5.76776e-02);
printf(" CII      2326 ,  3.065, %7.3f, %6.1f\n", cii2326,    100*( cii2326    - 3.06507e+00)/ 3.06507e+00);
printf(" NI       5200 ,  5.629, %7.3f, %6.1f\n", ni5200,     100*( ni5200     - 5.62900e+00)/ 5.62900e+00);
printf(" NII      5755 , 0.0019, %7.4f, %6.1f\n", nii5755,    100*( nii5755    - 1.94188e-03)/ 1.94188e-03);
printf(" NII      6548 ,  0.072, %7.3f, %6.1f\n", nii6548,    100*( nii6548    - 7.24793e-02)/ 7.24793e-02);
printf(" NII      6584 ,  0.213, %7.3f, %6.1f\n", nii6584,    100*( nii6584    - 2.13247e-01)/ 2.13247e-01);
printf(" OI       6300 ,  9.716, %7.3f, %6.1f\n", oi6300,     100*( oi6300     - 9.71562e+00)/ 9.71562e+00);
printf(" OII      3727 ,  0.448, %7.3f, %6.1f\n", oii3727,    100*( oii3727    - 4.48075e-01)/ 4.48075e-01);
printf(" OII      7319 , 0.0031, %7.4f, %6.1f\n", oii7319,    100*( oii7319    - 3.13112e-03)/ 3.13112e-03);
printf(" OII      7330 , 0.0025, %7.4f, %6.1f\n", oii7330,    100*( oii7330    - 2.53691e-03)/ 2.53691e-03);
printf(" NeII   12.81m ,  0.078, %7.3f, %6.1f\n", neii1281m,  100*( neii1281m  - 7.83286e-02)/ 7.83286e-02);
printf(" MgII     2798 , 25.410, %7.3f, %6.1f\n", mgii2798,   100*( mgii2798   - 2.54102e+01)/ 2.54102e+01);
printf(" SiIII    2335 ,  0.837, %7.3f, %6.1f\n", slii2335,   100*( slii2335   - 8.37034e-01)/ 8.37034e-01);
printf(" SiIII  18.71m , 0.0014, %7.4f, %6.1f\n", siii1871m,  100*( siii1871m  - 1.44160e-03)/ 1.44160e-03);
printf(" SII      6716 , 14.243, %7.3f, %6.1f\n", sii6716,    100*( sii6716    - 1.42433e+01)/ 1.42433e+01);
printf(" SII      6731 ,  9.779, %7.3f, %6.1f\n", sii6731,    100*( sii6731    - 9.77876e+00)/ 9.77876e+00);
printf(" ArII   6.985m ,  0.014, %7.3f, %6.1f\n", arii6985m,  100*( arii6985m  - 1.43115e-02)/ 1.43115e-02);
printf(" FeII   1.643m , 11.513, %7.3f, %6.1f\n", feii16435,  100*( feii16435  - 1.15127e+01)/ 1.15127e+01);
printf(" FeII   17.93m ,  3.637, %7.3f, %6.1f\n", feii1793m,  100*( feii1793m  - 3.63712e+00)/ 3.63712e+00);
printf(" NiII   6.636m ,  1.026, %7.3f, %6.1f\n", nkii6636m,  100*( nkii6636m  - 1.02599e+00)/ 1.02599e+00);
...
suml = suml*hb;
printf(" Ltot  e-10    , 126.88, %7.2f, %6.1f\n", suml   , 100*(suml     - 1.26883e+02)/1.26883e+02);
}
