#!/bin/bash
# MV v5.2.0 v4.03 bash looped and slotted PID version
#
########################################################################
#
...
#
cp Q/scripts/awk_* .
cp Q/scripts/gridrunheader.txt .
...
sed -e s/LPKVALUE/${pres}/g \
    ...
    -e s/MVERSION/${m_vers}/g \
    -e s/DVERSION/${d_vers}/g \
    -e s/DEPLFILE/${depl}/g  gridrunheader.txt >> grid_QZ-${type}_${1}.csv
#
########################################################################
#
...
sed -e s/LPKVALUE/${pres}/g \
    ...
    -e s/MVERSION/${m_vers}/g \
    -e s/DVERSION/${d_vers}/g \
    -e s/DEPLFILE/${depl}/g  gridrunheader.txt >> grid_ZQ-${type}_${1}.csv
#
########################################################################
#
