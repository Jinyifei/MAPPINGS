#!/bin/bash
# MV v5.2.0 v3.1.5 v4 bash looped and slotted PID version
#
########################################################################
#
...
#
cp A/scripts/awk_* .
cp A/scripts/gridrunheader.txt .
...
sed -e s/LPKVALUE/${pres}/g \
    ...
    -e s/MVERSION/${m_vers}/g \
    -e s/DVERSION/${d_vers}/g \
    -e s/DEPLFILE/${depl}/g  gridrunheader.txt >> grid_AGN_UM-${type}_${1}.csv
#
########################################################################
#
...
sed -e s/LPKVALUE/${pres}/g \
    ...
    -e s/MVERSION/${m_vers}/g \
    -e s/DVERSION/${d_vers}/g \
    -e s/DEPLFILE/${depl}/g  gridrunheader.txt >> grid_AGN_MU-${type}_${1}.csv
#
########################################################################
#
