...
c
      include 'const.inc'
c
      real*8 te,rate,ey,ra
      real*8 a,an,b,bn,bra,c,coeff,const
      real*8 d,ey22,ez21,fij,fn,fra,gag,pbra
      real*8 t,u,y,z
      integer*4 nz,n
c
      real*8 fue1
...
c
        if (n.eq.3) then
          fra=1.8d0*rate+5.47d-11/dsqrt(t)*(0.34d0*(t+15.8d4)*dexp(-
     &     15.8d4/t)-0.40d0*(t+25.d4)*dexp(-25.d4/t)+0.06d0*(t+84.d4)*
     &     dexp(-84.d4/t))
