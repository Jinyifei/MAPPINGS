...
c
      include 'cblocks.inc'
c
      real*8 t, telc, de, dh, hbet
      real*8 a1,a2,a3,a4,a5,ab1,ab2,abde
      real*8 amul,argu,b1,b2,bex,cormax,delc,delmu
      real*8 delo10,deloef,delomi,dlo,efden,fd,fmden,fnorm
      real*8 hbt0,he4471
      real*8 palph,raln,rmm,t5
      real*8 temul,tinv,tlo,tlolo,tmax,tmin,tspw,x
c
      integer*4 k,l
c
c
c           Functions
c
      real*8 fcor,fhb,fhb0,fli,fun
c
      fhb(dlo,t5,tlo)=1.d-25*(dexp(3.8328d0+0.083585d0*tlo-0.05177d0*
     &tlo*tlo))*(0.995d0*(1.d0+(dexp(-6.67d0+0.25516d0*dlo)*(t5**(-
     &1.2d0)))))
c
      fhb0(dlo,t5,tlo,fd)=(0.2392d-25*dexp((3.8328d0+(0.083585d0*tlo))-
     &((0.05177d0*tlo)*tlo)))*(0.995d0*(1.0+(fd*(dexp((-6.67d0)+
