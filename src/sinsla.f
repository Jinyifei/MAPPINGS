...
c! To compute the ionsation balance in a single zone for EQ and NEQ
c! @param [in] character     model  CHAR flags for calling model
c!
c! @return
c!  Most multizone models call this to solve a single zone
c!
c! @details
c! Requires nearly all of MAPPINGS with or without radition.
c! zone types availaible:
c!       B :  Equilibrium ionisation at a fixed temp.'/
c!       C :  Equilibrium ionisation and equilibrium temp.'/
c!       D :  Time dependent ionisation at equilibrium temp.'/
c!       E :  Time dependent ionisation at a fixed temp.'/
c!       F :  Time dependent ionisation and temperature.'/
c***************************************************************
