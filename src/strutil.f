...
c! FORTRAN version independent fold to uppper case but only a-z
c! @param [in,out] character*         s  input mixed case, out upper
c! @param [in,out] character*         t  out upper and trimmed
c!
c! @return
c!  folds s to upper case and trims in t but is fortran version
c!  independent. t is trimmed manually
c!
c! @details
c!  folds s to upper case and trims in t but is fortran version
c!  independent. t is trimmed manually and library trim is not needed.
c***************************************************************
